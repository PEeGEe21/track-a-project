    ...
    <Layout>
        ...
        <div className='px-4 py-10'>
            ...
            <div className='flex items-center justify-end gap-3 pt-4'>
                    ...
                    <button className=" p-2  bg-white text-white transition ease-in duration-200 text-center text-sm font-normal  rounded flex items-center justify-center wrapper relative border border-white hover:bg-gray-200 hover:border-gray-500 hover:border ">
                        <svg className='h-6 w-6' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="#4A4957" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                            <path d="M2 12H22" stroke="#4A4957" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                            <path d="M12 2C14.5013 4.73835 15.9228 8.29203 16 12C15.9228 15.708 14.5013 19.2616 12 22C9.49872 19.2616 8.07725 15.708 8 12C8.07725 8.29203 9.49872 4.73835 12 2V2Z" stroke="#4A4957" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                    ...
                    <button className={` p-2  bg-white transition ease-in duration-200 text-center text-sm font-normal  rounded flex items-center justify-center wrapper relative border border-white hover:bg-gray-200 hover:border-gray-500 hover:border dropdown-active_btn `} onClick={showPeersDropdown}>
                                                ...
                                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none h-full">
                                                        <span className="text-gray-500 px-3">
                                                            <svg width="22" height="22" viewBox="0 0 20 20" className="mr-3 pr-2" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M9.16667 15.8333C12.8486 15.8333 15.8333 12.8486 15.8333 9.16667C15.8333 5.48477 12.8486 2.5 9.16667 2.5C5.48477 2.5 2.5 5.48477 2.5 9.16667C2.5 12.8486 5.48477 15.8333 9.16667 15.8333Z" stroke="#9998A9" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                                <path d="M17.5 17.5L13.875 13.875" stroke="#9998A9" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                                </svg>
                                                        </span>
                                                </div>
                                            ...
                                            <button className=" flex items-center justify-between mt-3 p-2 w-full hover:bg-gray-200 rounded">
                                                ...
                                                <span>
                                                    <svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M12.3346 1L5.0013 8.33333L1.66797 5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                    </svg>
                                                </span>
                                            </button>
                    ...
                    <button className=" p-2  bg-white transition ease-in duration-200 text-center text-sm font-normal  rounded flex items-center justify-center wrapper relative border border-white hover:bg-gray-200 hover:border-gray-500 hover:border">
            ...
            <div>
                <h1 className='text-[45px]'>new users regiS</h1>
                <p className='text-[#6c7293] text-sm '>Added on the 21st August, 2022 at 10:22pm</p>
                <p className='my-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla natus est veniam dolorem inventore eligendi qui impedit perspiciatis praesentium ea? Perferendis accusamus a quod odio fuga quibusdam tempora eaque laudantium..</p>
            </div>
            ...
            <div className='my-8 pt-12'>
                <div className='grid md:grid-cols-3 grid-cols-1 '>
                    <div className='px-4 py-3'>
                        ...
                        <div className='p-4 bg-green-400 flex items-center justify  rounded'>
                    ...
                    <div className='px-4 py-3'>
                        <div className='p-4 dropdown bg-orange-400 flex items-center justify rounded'>
                                    ...
                                    <div className={`dropdown-menu large-dropdown px-3 py-3 shadow-box rounded-md w-full h-auto  scrollbar-change border-none ${addProgressDropdown ? "fade-in" : ""}`}>
                                        <div className="">
                                            <div className=" flex justify-start mt-3 mb-3">
                                                ...
                                                <label className="form-check-label inline-block text-gray-800 w-full cursor-pointer" for="agree_check">Edit HomePage</label>
                                            </div>
                                            <div className="form-group form-check flex justify-start mt-3 mb-3 w-full">
                                                ...
                                                />
                                                <label className="form-check-label inline-block text-gray-800 w-full cursor-pointer" for="agree_check2">Edit HomePage2</label>
                                            </div>
                                        </div>
                                    </div>
                            </div>
                    ...
                    <div className='px-4 py-3'>
                        <div className='p-4 bg-blue-400 flex items-center justify rounded '>
