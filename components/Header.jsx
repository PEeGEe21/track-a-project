...
const Header = () => {
  return (
    <>
        <div className="header sticky top-0 bg-white py-2 w-full px-4x z-[999] rounded">
                <div className="container mx-auto flex items-center justify-between gap-8 md:px-4 ">
                    ...
                    <div className="flex items-center justify-end gap-1 md:gap-8 px-1 md:px-4">
                            

                            <div className="dropdown relative  grow  " data-large-dropdown>
                                    

                                    <button className="flex items-center justify-center gap-0 md:gap-2 border-r px-2 md:px-5 border-[#E4E7EC] focus:outline-none active:outline-none" data-large-dropdown-btn>
                                        ...
                                        <div className="flex items-start justify-start flex-col pointer-events-none">
                                            ...
                                            <span className="user font-medium ">Peegee</span>
                                        </div>
                                    ...
                                    <div className=" dropdown-menu large-dropdown shadow-box rounded-md w-full border-0 ">
                                            ...
                                            <div className=" py-2">
                                                ...
                                                <button className="flex items-center py-2 px-4 text-sm justify-start bg-white border-0 w-full hover:bg-gray-100 text-neutral600">
                                                    <span className="mr-3">
                                                        ...
                                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M8.89844 7.55999C9.20844 3.95999 11.0584 2.48999 15.1084 2.48999H15.2384C19.7084 2.48999 21.4984 4.27999 21.4984 8.74999V15.27C21.4984 19.74 19.7084 21.53 15.2384 21.53H15.1084C11.0884 21.53 9.23844 20.08 8.90844 16.54" stroke="#EF4444" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                            <path d="M15.0011 12H3.62109" stroke="#EF4444" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                ...
                                {/* <span className="relative">
                                    <span className="w-2 h-2 rounded-full absolute left-2 leading text-xs bg-secondary500 top-0 "></span>
                                        ...
                                        <svg width="20" height="23" viewBox="0 0 20 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M10 17.3476C15.6392 17.3476 18.2481 16.6242 18.5 13.7205C18.5 10.8188 16.6812 11.0054 16.6812 7.44511C16.6812 4.66414 14.0452 1.5 10 1.5C5.95477 1.5 3.31885 4.66414 3.31885 7.44511C3.31885 11.0054 1.5 10.8188 1.5 13.7205C1.75295 16.6352 4.36177 17.3476 10 17.3476Z" stroke="#667085" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M12.3889 20.3572C11.0247 21.8719 8.89672 21.8899 7.51953 20.3572" stroke="#667085" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                </span> */}
                            </div>
                    </div>
